...
class TCPDF {
	 ...
	 * @public
	 */
	public function UTF8ArrSubString(array $strarr, int $start=0, int $end=0) {
		$string = '';
		for ($i=$start; $i < $end; ++$i) {
	 ...
	 * @since 2.4.000 (2008-03-06)
	 */
	protected function utf8Bidi(array $ta, string $str='', bool $forcertl=false) {
