...
<div class="wpp_feps_form feps_spc_details_wrapper">
  <ul class="feps_spc_details">
    <li class="<?php wpp_css("feps-purchase-template::row-wrapper", array("wpp_feps_row_wrapper")); ?>">
      ...
      <div class="<?php wpp_css("feps-purchase-template::input-wrapper","wpp_feps_input_wrapper"); ?>">
        <div class="<?php wpp_css("feps-purchase-template::input-content","wpp_feps_input_content"); ?>">
          ...
          <span class="wpp_feps_edit_property">( <a href="<?php echo class_wpp_feps::get_edit_feps_permalink( $_REQUEST['feps'], 'edit' ); ?>" ><?php _e( 'Edit', ud_get_wpp_feps()->domain ); ?></a> )</span>
          <div class="description"><?php printf( __( 'You can modify the current %s anytime.', ud_get_wpp_feps()->domain ), WPP_F::property_label() ); ?></div>
          <?php endif; ?>
        </div>
      </div>
    ...
    <li class="<?php wpp_css("feps-purchase-template::row-wrapper", array("wpp_feps_row_wrapper")); ?>">
      <div class="<?php wpp_css("feps-purchase-template::label-wrapper", array("wpp_feps_label_wrapper")); ?>">
        <label><?php _e( 'Subscription Plan', ud_get_wpp_feps()->domain ); ?></label>
      </div>
      <div class="<?php wpp_css("feps-purchase-template::input-wrapper","wpp_feps_input_wrapper"); ?>">
        <div class="<?php wpp_css("feps-purchase-template::input-content","wpp_feps_input_content"); ?>">
          <strong><?php echo $plan[ 'name' ]; ?></strong> <span class="wpp_feps_change_subscription_plan">( <a href="<?php echo class_wpp_feps::get_edit_feps_permalink( $_REQUEST['feps'], 'subscription_plan' ); ?>" ><?php _e( 'Change', ud_get_wpp_feps()->domain ); ?></a> )</span>
          <ul class="<?php wpp_css("feps-purchase-template::info","wpp_feps_subscription_plan_info"); ?>">
            <li class="<?php wpp_css("feps-purchase-template::info-element","price"); ?>">
              ...
              <span><strong><?php echo $wpi_settings['currency']['symbol'][$wpi_settings['currency']['default_currency_code']]; ?><?php echo sprintf("%01.2f", $plan['price']); ?></strong></span> ( <?php printf( __( '%s%01.2f = %01.2f credit', ud_get_wpp_feps()->domain ), $wpi_settings['currency']['symbol'][$wpi_settings['currency']['default_currency_code']], 1, 1 ); ?> )
            </li>
            <li class="<?php wpp_css("feps-purchase-template::info-element","duration"); ?>">
              <label><?php _e('Duration:', ud_get_wpp_feps()->domain); ?></label>
              <span><?php printf( "%d %s", $plan['duration']['value'], _n( $plan['duration']['interval'], $plan['duration']['interval'].'s', $plan['duration']['value'], ud_get_wpp_feps()->domain ) ); ?></span>
            </li>
            <li class="<?php wpp_css("feps-purchase-template::info-element","is_featured"); ?>">
              <label><?php _e( 'Featured:', ud_get_wpp_feps()->domain ); ?></label>
              <span><?php ( isset( $plan[ 'is_featured' ] ) && $plan[ 'is_featured' ] == 'true' ) ? _e( 'Yes', ud_get_wpp_feps()->domain ) : _e( 'No', ud_get_wpp_feps()->domain ); ?></span>
            </li>
    ...
    <?php if ( is_user_logged_in() ) : ?>
      <li class="<?php wpp_css("feps-purchase-template::row-wrapper", array("wpp_feps_row_wrapper")); ?>">
        <div class="<?php wpp_css("feps-purchase-template::label-wrapper", array("wpp_feps_label_wrapper")); ?>">
          <label><?php _e( 'Current Balance', ud_get_wpp_feps()->domain ); ?></label>
        </div>
        <div class="<?php wpp_css("feps-purchase-template::input-wrapper","wpp_feps_input_wrapper"); ?>">
          <div class="<?php wpp_css("feps-purchase-template::input-content","wpp_feps_input_content"); ?>">
            <?php printf("%01.2f", $credits); ?> <?php _e( 'credits', ud_get_wpp_feps()->domain ); ?>
          </div>
        </div>
        <div class="<?php wpp_css("feps-purchase-template::clear","clear"); ?>"></div>
      </li>
  ...
  <ul class="<?php wpp_css("feps-purchase-template::fields-wrapper","feps_user_input_fields"); ?> submit_action_wrapper">
    <li class="<?php wpp_css("feps-purchase-template::input-wrapper","wpp_feps_input_wrapper submit_action"); ?> ">
      ...
      <form class="<?php wpp_css("feps-purchase-template::form",""); ?> wpp_feps_withdraw_credits">
        ...
        <div class="pay_now">
          <div class="<?php wpp_css("feps-purchase-template::action_button","wpp_feps_action_button"); ?>"><input type="submit" value="<?php printf( __( 'Publish the current %s', ud_get_wpp_feps()->domain), WPP_F::property_label() ); ?>"></div>
          <div class="<?php wpp_css("feps-purchase-template::action_notification","wpp_feps_action_notification"); ?>">
            <div class="<?php wpp_css("feps-purchase-template::action_notification_content","wpp_feps_action_content"); ?>">
              <?php printf( __( '<strong>%01.2f</strong> credits will be withdrawn from your balance.', ud_get_wpp_feps()->domain ), $plan['price'] ); ?>
            </div>
          </div>
          <div class="<?php wpp_css("feps-purchase-template::clear","clear"); ?>"></div>
        </div>
      ...
      <?php else : ?>
        <div class="add_credits">
          <div class="<?php wpp_css("feps-purchase-template::action_button","wpp_feps_action_button"); ?>"><input type="submit" value="<?php _e( 'Add Credits', ud_get_wpp_feps()->domain); ?>"></div>
          <div class="<?php wpp_css("feps-purchase-template::action_notification","wpp_feps_action_notification"); ?>">
            <div class="<?php wpp_css("feps-purchase-template::action_notification_content","wpp_feps_action_content"); ?>">
              <?php echo sprintf( __('You don\'t have enough credits on your balance. Current submission requires <strong>%01.2f</strong> credits. After credits will be added, the current %s will be automatically published.', ud_get_wpp_feps()->domain), $plan['price'], WPP_F::property_label() ); ?>
            </div>
          </div>
          <div class="<?php wpp_css("feps-purchase-template::clear","clear"); ?>"></div>
        </div>
