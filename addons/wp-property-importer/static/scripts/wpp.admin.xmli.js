...
// Fix for missing strings. - potanin@UD
wpp.strings.xmli = wpp.strings.xmli || { toggle_advanced: 'Toggle Advanced', please_save: 'Please Save' };
...
wpp.xmli = jQuery.extend({
  ...
  ready: function ready() {
    ...
    jQuery( "#wpp_property_import_ajax" ).on( "click", ".wpp_xi_sort_rules", function () {
    ...
    jQuery( "#wpp_property_import_ajax" ).on( "change", "#wpp_property_import_choose_root_element", function () {
      var value = jQuery( this ).val();
      var fixed_value = value.replace( /'/g, '"' );
      jQuery( this ).val( fixed_value );
    });

    jQuery( "#wpp_property_import_ajax" ).on( "change", ".wpp_xi_advanced_setting input[type=checkbox]", function () {
    ...
    jQuery( "#wpp_property_import_ajax" ).on( "change", ".wpp_xi_advanced_setting input[type=text]", function () {
      var wrapper = jQuery( this ).closest( ".wpp_xi_advanced_setting" );
      var value = jQuery( this ).val();
    ...
    jQuery( "#wpp_property_import_ajax" ).on( "click", '.wpp_property_toggle_import_settings', function () {
      jQuery( ".wpp_property_import_settings" ).toggle();
      wpp.xmli.advanced_option_counter();
    });

    jQuery( "#wpp_property_import_ajax" ).on( "click", ".wpp_import_delete_row", function () {
    ...
    jQuery( "#wpp_property_import_ajax" ).on( 'click', '#check_all', function () {
      if ( jQuery(this).is(':checked') ) {
    ...
    jQuery( "#wpp_property_import_ajax" ).on( "click", "#wpp_i_do_full_import", function () {
     ...
     * @since 4.0.3
     */
    jQuery( document ).on( "click", "#wpp_i_do_media_import", function () {
    ...
    jQuery( "#wpp_property_import_ajax" ).on( "click", "#wpp_i_preview_action", function () {
    ...
    jQuery( "#wpp_property_import_ajax" ).on( "click", ".wpp_i_close_preview", function () {
    ...
    jQuery( "#wpp_property_import_ajax" ).on( "click", "#wpp_i_preview_raw_data", function () {
    ...
    jQuery( "#wpp_property_import_ajax" ).on( "click", "#wpp_import_auto_match", function () {
      wpp.xmli.perform_auto_matching();
    });

    jQuery( "#wpp_property_import_ajax" ).on( "click", "#wpp_property_import_save", function ( e ) {
    ...
    jQuery( "#wpp_property_import_ajax" ).on( "click", "#wpp_property_import_update", function ( e ) {
...
//** Switch sorting direction */
    ...
    jQuery( "#wpp_property_import_ajax" ).on( "change", "#wpp_property_import_remote_url, #wpp_property_import_username, #wpp_property_import_password", function () {
      wpp.xmli.determine_settings( {} );
    });

    /* If source is selected, remove error and determine settings */
    jQuery( "#wpp_property_import_ajax" ).on( "change", "#wpp_property_import_source_type", wpp.xmli.source_changed );

    /* Vlidate source when "Source is Good" label is pressed. Third argument forces cache refresh. */
    jQuery( "#wpp_property_import_ajax" ).on( 'click', '#wpp_property_import_source_status', function () {
      wpp.xmli.evaluate_source( this, false, true );
    });

    jQuery( "#wpp_property_import_ajax" ).on( 'change', "#wpp_property_import_unique_id", function () {
      wpp.xmli.import_build_unique_id_selector();
    });

    jQuery( "#wpp_property_import_ajax" ).on( 'change', 'select[name^="wpp_property_import[map]"]', function () {
      wpp.xmli.import_build_unique_id_selector();
    });
     ...
     */
    jQuery( "#wpp_property_import_ajax" ).on( 'click', 'a.toggle_advanced_settings', function() {
     ...
     * Add Match
     */
    jQuery( "#wpp_property_import_ajax" ).on( 'click', '.add_match_row', function() {
     ...
     * Remove Match
     */
    jQuery( "#wpp_property_import_ajax" ).on( 'click', '.remove_match_row', function() {
