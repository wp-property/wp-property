!function($) {
    var feps_subsc_form = function(el) {
        el.each(function(i, e) {
            return $(e).hasClass("feps_subsc_form_activated") ? null : ($("li.wpp_feps_row_wrapper", e).click(function() {
                $('input[name="subscription_plan"]', e).val($(this).data("subsc_plan")), $("li.wpp_feps_row_wrapper", e).removeClass("feps_plan_selected"), 
                $(this).addClass("feps_plan_selected");
            }), $(e).addClass("feps_subsc_form_activated"), void 0);
        });
    };
