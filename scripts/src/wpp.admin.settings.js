 ...
 *
 */
define( 'wpp.admin.settings', [ 'wpp.model', 'knockout', 'knockout.mapping' ], function(  ) {
  ...
  return function domReady() {
    ...
    jQuery( '#wpp_settings_form' ).submit( function() {
      if( !jQuery( '#wpp_backup_file' ).val() ) {
        ...
        jQuery.ajax( {
          ...
          error: function() {
            alert( model.locale.undefined_error );
            btn.prop( 'disabled', false );
          }
        } );
        return false;
    ...
    jQuery( "#wpp_ajax_revalidate_all_addresses" ).click( function() {
      jQuery( this ).val( model.locale.processing );
    ...
    jQuery( "#wpp_ajax_max_set_property_type" ).click( function() {
      if( !confirm( model.locale.set_property_type_confirmation ) ) {
        return;
      }
      jQuery.post( model.ajax, {
