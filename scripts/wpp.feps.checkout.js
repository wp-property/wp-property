    ...
    function wpp_feps_checkout_event(event, result, target) {
        ...
        switch (event) {
          ...
          case "wpi_spc_success":
            jQuery(target).parents(".wpp_feps_checkout_wrapper").remove(), jQuery(".wpp_feps_change_subscription_plan").remove(), 
            message = result.message;
        }
        var property_id = "undefined" != typeof result.callback.post_data["wpp::feps::property_id"][0] ? result.callback.post_data["wpp::feps::property_id"][0] : null;
