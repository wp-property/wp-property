...
"function" != typeof wpp.init_feps_form && (wpp.init_feps_form = function(this_form) {
    function submit_form() {
        ...
        jQuery.post(wpp.instance.ajax_url, {
            ...
            this_form.remove()) : (this_form.prev().html(response.message).show(), this_form.remove()) : (this_form.prev().addClass("error"), 
    ...
    function wpp_feps_lookup_email() {
        ...
        }, "json"), void 0) : (submit_button.removeAttr("disabled"), !1);
    }
