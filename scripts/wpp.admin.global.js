...
function toggle_advanced_options() {
    jQuery(".wpp_show_advanced").live("click", function() {
        ...
        jQuery(this).is("input[type=checkbox]")) {
            ...
            return jQuery(this).is(":checked") ? "reverse" == toggle_logic ? jQuery(element_path).hide() : jQuery(element_path).show() : "reverse" == toggle_logic ? jQuery(element_path).show() : jQuery(element_path).hide(), 
            void 0;
        }
...
function wpp_toggle_contextual_help(element) {
    ...
    }), scroll_to && scroll_to.removeClass("wpp_contextual_highlight"), void 0) : help_link.hasClass("screen-meta-active") ? void 0 : (help_link.addClass("screen-meta-active"), 
    scroll_to && scroll_to.addClass("wpp_contextual_highlight"), panel.slideDown("fast", function() {
...
jQuery(document).ready(function() {
    jQuery("#contextual-help-link").click(function() {
        ...
        jQuery(parent).remove()) : jQuery(parent).attr("new_row", "true"), table.trigger("row_removed", [ parent ]), 
        void 0) : !1;
