...
class WPP_Core {
  ...
  function init_lower() {
    ...
    add_action( 'wp_ajax_wpp_apply_default_value', create_function( "", ' die(WPP_F::wpp_apply_default_value());' ) );
    ...
    wp_localize_script( 'wp-property-admin-settings', 'attributes_default_support', ud_get_wp_property()->get('attributes.default'));
