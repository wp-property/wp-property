...
class WPP_Core {
  ...
  function WPP_Core() {
    ...
    self::$modules = WPP_F::load_premium( array(
      ...
      'main_map' => array(
        ...
        'power-tools'   => array(
          'power-tools/lib/class-power-tools.php'
        ),
        'facebook-tabs' => array(
          'facebook-tabs/lib/class-facebook-tabs.php'
        ),
        'pdf'           => array(
          'pdf/lib/class-pdf.php'
        ),
        'slideshow'     => array(
  ...
  public function wp_loaded() {
    ...
    wp_register_script( 'wp-property-admin-overview', WPP_URL . 'static/scripts/wpp.admin.overview.js', array( 'jquery', 'wpp-localization' ), WPP_Version );
    wp_register_script( 'wp-property-admin-widgets', WPP_URL . 'static/scripts/wpp.admin.widgets.js', array( 'jquery', 'wpp-localization' ), WPP_Version );
    ...
    wp_register_style( 'wpp-jquery-data-tables', WPP_URL . "static/styles/wpp.admin.data.tables.css" );
  ...
  public function admin_menu() {
    ...
    $this->pages[ 'settings' ] = add_submenu_page( 'edit.php?post_type=property', __( 'Settings', 'wpp' ), __( 'Settings', 'wpp' ), 'manage_wpp_settings', 'property_settings', array( $_page->settings, 'section' ) );
    $this->pages[ 'overview' ] = add_submenu_page( 'edit.php?post_type=property', $wp_properties[ 'labels' ][ 'all_items' ], $wp_properties[ 'labels' ][ 'all_items' ], 'edit_wpp_properties', 'all_properties', array( $_page->overview, 'section' ) );
  ...
  function admin_init() {
    ...
    if( ( isset( $_REQUEST[ 'page' ] ) && $_REQUEST[ 'page' ] == 'property_settings' )
      && ( isset( $_REQUEST[ 'wpp_action' ] ) && $_REQUEST[ 'wpp_action' ] == 'download-wpp-backup' )
