!function($) {
    $.fn.wpp_rs_lb = function(prop) {
        ...
        function showLightbox(img) {
            ...
            options.galleryTop.params.slideshow_layout = !1, options.galleryTop.activeIndex = activeIndex, 
            options.galleryThumbs.activeIndex = activeIndex, loadFullImageLazy(), lb.addClass("lightbox"), 
