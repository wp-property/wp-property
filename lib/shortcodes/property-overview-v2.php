...
/**
 * Shortcode: [property_overview_v2]
 *
 * @since 2.0.5
 */
namespace UsabilityDynamics\WPP {

  if (!class_exists('UsabilityDynamics\WPP\Property_Overview_Shortcode_V2')) {

    class Property_Overview_Shortcode_V2 extends Shortcode
    {
     ...
     * Register
     */
    new Property_Overview_Shortcode_V2();
