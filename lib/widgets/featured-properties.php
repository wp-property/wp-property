 ...
 * ID: Featured_Properties_Widget
 * Type: widget
 * Group: WP-Property
 * Class: \UsabilityDynamics\WPP\Featured_Properties_Widget
 * Version: 2.0.0
 * Description: List of properties that were marked as Featured
 */
namespace UsabilityDynamics\WPP {

  if( !class_exists( 'UsabilityDynamics\WPP\Featured_Properties_Widget' ) ) {
    /**
     * Lookup Widget
     *
     */
    class Featured_Properties_Widget extends Widget {
      ...
      function __construct() {
        ...
        parent::__construct( 
          false, 
          $name = sprintf( __( 'Featured %1s', 'wpp' ), \UsabilityDynamics\WPP\Utility::property_label( 'plural' ) ), 
          array( 
            'description' => sprintf( __( 'List of %1s that were marked as Featured', 'wpp' ), \UsabilityDynamics\WPP\Utility::property_label( 'plural' ) ) 
          ) 
        );
      }
      ...
      function widget( $args, $instance ) {
        ...
        $all_featured = \UsabilityDynamics\WPP\Utility::get_properties( "featured=true&property_type=all&pagi=0--{$amount_items}{$random_sort}" );
        ...
        foreach ( $all_featured as $featured ) {
          ...
          $count++;
          $this_property = \UsabilityDynamics\WPP\Utility::get_property( $featured, 'return_object=true' );
