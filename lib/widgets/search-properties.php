 ...
 * Type: widget
 * Group: WP-Property
 * Class: \UsabilityDynamics\WPP\Search_Properties_Widget
 * Version: 2.0.0
 * Description: Display a highly customizable property search form
 */
namespace UsabilityDynamics\WPP {

  if( !class_exists( 'UsabilityDynamics\WPP\Search_Properties_Widget' ) ) {
    /**
     * Property Search Widget
     */
    class Search_Properties_Widget extends Widget {
      ...
      function __construct() {
        ...
        parent::__construct(
          ...
          array(
            ...
            'description' => sprintf( __( 'Display a highly customizable  %1s search form.', 'wpp' ), Utility::property_label() )
          ),
          array(
            'width' => 300
          )
