...
class Property_Attributes_Widget extends WP_Widget {
  ...
  function __construct() {
    ...
    parent::__construct(
      ...
      sprintf( __( '%1s Attributes', 'wpp' ), \UsabilityDynamics\WPP\Utility::property_label() ),
      array(
  ...
  function widget( $args, $instance ) {
    ...
    foreach( $instance as $slug => $option ) {
      ...
      if( $show_labels ) {
        $attribute = \UsabilityDynamics\WPP\Utility::get_attribute_data( $slug );
      }
  ...
  function form( $instance ) {
    ...
    foreach( \UsabilityDynamics\WPP\Utility::get_total_attribute_array() as $slug => $label ) {
      $main_options[ $slug ] = \UsabilityDynamics\WPP\Utility::get_attribute_data( $slug );
    }
