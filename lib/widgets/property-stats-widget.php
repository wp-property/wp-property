...
namespace UsabilityDynamics\WPP\Widgets {
  ...
  class PropertyStatsWidget extends \UsabilityDynamics\WPP\Widget {
    ...
    public function __construct() {
      parent::__construct( 'wpp_property_stats', $name = sprintf( __( '%1s Stats', ud_get_wp_property()->domain ), \WPP_F::property_label() ), array( 'description' => __( 'Widget for Single Property page that renders property attributes table.', ud_get_wp_property()->domain ) ) );
    }
