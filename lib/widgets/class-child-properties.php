...
class ChildPropertiesWidget extends WP_Widget {
  ...
  function ChildPropertiesWidget() {
    parent::WP_Widget( false, $name = sprintf( __( 'Child %1s', 'wpp' ), \UsabilityDynamics\WPP\Utility::property_label( 'plural' ) ), array( 'description' => sprintf( __( 'Show child %1s (if any) for currently displayed %2s', 'wpp' ), \UsabilityDynamics\WPP\Utility::property_label( 'plural' ), \UsabilityDynamics\WPP\Utility::property_label( 'singular' ) ) ) );
  }
