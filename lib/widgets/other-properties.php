 ...
 * ID: Other_Properties_Widget
 * Type: widget
 * Group: WP-Property
 * Class: \UsabilityDynamics\WPP\Other_Properties_Widget
 * Version: 2.0.0
 * Description: Display a list of properties that share a parent with the currently displayed property
 */
namespace UsabilityDynamics\WPP {

  if( !class_exists( 'UsabilityDynamics\WPP\Other_Properties_Widget' ) ) {
    /**
     * Other Properties Widget
     */
    class Other_Properties_Widget extends Widget {
      ...
      function __construct() {
        ...
        parent::__construct(
          ...
          array(
            'description' => sprintf( __( 'Display a list of %1s that share a parent with the currently displayed property.', 'wpp' ), Utility::property_label( 'plural' ), Utility::property_label( 'singular' ) )
          ),
          array(
            'width' => 300
          )
