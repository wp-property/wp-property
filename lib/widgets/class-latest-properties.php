...
class LatestPropertiesWidget extends WP_Widget {
  ...
  function LatestPropertiesWidget() {
    parent::WP_Widget( false, $name = sprintf( __( 'Latest %1s', 'wpp' ), \UsabilityDynamics\WPP\Utility::property_label( 'plural' ) ), array( 'description' => sprintf(__( 'List of the latest %1s created on this site', 'wpp' ), \UsabilityDynamics\WPP\Utility::property_label( 'plural' ) ) ) );
  }
