...
class FeaturedPropertiesWidget extends WP_Widget {
  ...
  function FeaturedPropertiesWidget() {
    parent::WP_Widget( false, $name = sprintf( __( 'Featured %1s', 'wpp' ), \UsabilityDynamics\WPP\Utility::property_label( 'plural' ) ), array( 'description' => sprintf( __( 'List of %1s that were marked as Featured', 'wpp' ), \UsabilityDynamics\WPP\Utility::property_label( 'plural' ) ) ) );
  }
