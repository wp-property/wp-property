  ...
  if ( !class_exists( 'UsabilityDynamics\WPRETSC\Connectors\WPProperty' ) ) {
    ...
    final class WPProperty {
      ...
      public function __construct() {
        ...
        /**
         * If x_debug parameter or header is provided we add metabox to Edit Property page
         * which contains terms and meta data.
         */
        if( isset($_GET['x_debug']) || isset( $_SERVER['HTTP_X_DEBUG'] ) ) {
          add_action( 'add_meta_boxes', function() {
            add_meta_box( 'meta', __( 'Meta Prints' ), array( $this, 'metabox_property_debug' ), 'property' );
          } );
        }
      ...
      /**
       * Renders Metabox with printed property's terms and meta
       *
       * @param $post
       */
      function metabox_property_debug( $post ) {
