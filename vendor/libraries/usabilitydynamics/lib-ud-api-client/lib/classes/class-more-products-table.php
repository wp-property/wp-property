      ...
      public function display_rows() {
        ...
        foreach ( (array) $this->items as $product ) {
          ...
          if( !empty( $product['url'] ) ) {
            $action_links[] = '<a target="_blank" class="install-now button" href="' . $product['url'] . '" aria-label="' . __( 'Visit plugin site' ) . '">' . __( 'Visit plugin site' ) . '</a>';
          }
          ...
          <div class="plugin-card">
            <div class="plugin-card-top" style="min-height:200px;">
              <?php if( !empty( $product[ 'icon' ] ) ) { ?>
                <div class="plugin-icon"><img src="<?php echo esc_attr( $product[ 'icon' ] ) ?>" /></div>
              <?php } ?>
