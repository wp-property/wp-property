  ...
  */
            ...
            <tr>
              ...
              <td>
                ...
                <ul>
                  ...
                  <li>
                    <input id="can_manage_feps_<?php echo $form_id; ?>" type="checkbox" name="wpp_feps[forms][<?php echo $form_id; ?>][can_manage_feps]" <?php checked('true', $form['can_manage_feps']); ?> value="true" />
                  ...
                  <li <?php echo $hidden; ?>>
                    <input id="user_creation_<?php echo $form_id; ?>" type="checkbox" name="wpp_feps[forms][<?php echo $form_id; ?>][notifications][user_creation]" <?php checked('disable', $form['notifications']['user_creation']); ?> value="disable" />
                    <label for="user_creation_<?php echo $form_id; ?>"><?php _e('Disable new user account creation notification.', 'wpp'); ?></label>
                  </li>
                  <li>
                    <input id="on_status_updated_<?php echo $form_id; ?>" type="checkbox" name="wpp_feps[forms][<?php echo $form_id; ?>][notifications][on_status_updated]" <?php checked('true', $form['notifications']['on_status_updated']); ?> value="true" />
                    ...
                    <tr class="wpp_dynamic_table_row" random_row_id="<?php echo $row_id; ?>">
                      ...
                      <td class="main_feps">
                        <ul>
                          ...
                          <li class="wpp_development_advanced_option">
                            <input id="required_<?php echo $form_id; ?>_<?php echo $row_id; ?>" type="checkbox" name="wpp_feps[forms][<?php echo $form_id; ?>][fields][<?php echo $row_id; ?>][required]" <?php checked('on', $field_data['required']); ?> />
                            <label for="required_<?php echo $form_id; ?>_<?php echo $row_id; ?>"><?php _e('Required'); ?></label>
                          </li>
                          <li class="wpp_development_advanced_option">
  ...
  function spc_options_general( $args = '' ) {
    ...
    <li>
      ...
      <input id="feps_credits_<?php echo $form_id; ?>" type="checkbox" name="wpp_feps[forms][<?php echo $form_id; ?>][feps_credits]" <?php checked('true', $form['feps_credits']); ?> class="wpp_show_advanced feps_credits" advanced_option_class="wpp_advanced_option" value="true" />
  ...
  function feps_pay_now() {
    ...
    if ( wp_verify_nonce($_REQUEST['_wpnonce'], 'wpp_feps_pay_now') ) {
      ...
      if ( is_user_logged_in() ) {
        ...
        update_post_meta( $property_id, FEPS_META_PLAN, $subscription_plan_data );
