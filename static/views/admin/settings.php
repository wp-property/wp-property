...
<div class="wrap <?php echo implode(' ', $wrapper_classes); ?>">
  ...
  <h2
    ...
    <?php if (isset($wp_properties["configuration"]) && isset($wp_properties["configuration"]["show_assistant"])) { ?>
    ...
    <div class="wpp_fb_like">
      <div class="fb-like" data-href="https://www.facebook.com/wpproperty" data-send="false" data-layout="button_count"
            ...
            <td>
              <ul>
                ...
                <li class="configuration_enable_layouts"
                    data-feature-since="2.2.1"><?php echo WPP_F::checkbox("name=wpp_settings[configuration][enable_layouts]&label=" . __('Enable layouts', ud_get_wp_property()->domain), (isset($wp_properties['configuration']['enable_layouts']) ? $wp_properties['configuration']['enable_layouts'] : true)); ?></li>
                <li
            ...
            <td>
              <ul>
                ...
                <li class="google-maps-api-section" data-feature-since="2.0.3">
                  ...
                  <br/><span
                    class="description"><?php printf(__('Note, Google Maps has its own limit of usage. You can provide Google Maps API license ( key ) above to increase limit. See more details %shere%s.', ud_get_wp_property('domain')), '<a href="https://developers.google.com/maps/documentation/javascript/usage#usage_limits" target="_blank">', '</a>'); ?></span>
                  <br/><span
                    class="description"><?php printf(__('%s Where can I get the key ? %s.', ud_get_wp_property('domain')), '<a href="https://developers.google.com/maps/documentation/javascript/get-api-key" target="_blank">', '</a>'); ?></span>
