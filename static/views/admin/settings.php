          ...
          <tr>
            ...
            <td>
              ...
              <ul>
                ...
                <li><?php echo WPP_F::checkbox('name=wpp_settings[configuration][property_overview][using_fancybox]&label=' . sprintf(__('Enable fancybox plugin.', ud_get_wp_property()->domain), $object_label['singular']), $wp_properties['configuration']['property_overview']['using_fancybox']); ?></li>
