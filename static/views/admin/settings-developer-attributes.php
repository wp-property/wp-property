...
<table id="wpp_inquiry_attribute_fields" class="wpp_inquiry_attribute_fields ud_ui_dynamic_table widefat" allow_random_slug="true">
  ...
  <!-- Hidden row for cloning with jQuery. Transmitted data from input fields will be removed with 'wpp_settings_remove_preset_values' function. -->
  <tr class="wpp_dynamic_table_row"  slug="__first_row" new_row='false' style="display: none">
    ...
    <td class="wpp_attribute_name_col">
      <ul class="wpp_attribute_name">
        <li>
          <input class="slug_setter" type="text" name="wpp_settings[property_stats][__first_row]" value=""/>
        </li>
        <li class="wpp_development_advanced_option">
          <input type="text" class="slug wpp_stats_slug_field" readonly='readonly' value=""/>
        </li>
        <li>
    ...
    <td class="wpp_attribute_group_col">
      <input type="text" class="wpp_attribute_group wpp_group" value=""/>
      <input type="hidden" class="wpp_group_slug" name="wpp_settings[property_stats_groups][__first_row]" value="">
    </td>
    ...
    <td class="wpp_settings_input_col">
      <ul>
        <li>
          <label>
            <input type="checkbox" class="slug" name="wpp_settings[sortable_attributes][]" value=""/>
            <?php _e( 'Sortable.', ud_get_wp_property()->domain ); ?>
          </label>
        </li>
        <li>
          <label>
            <input type="checkbox" class="slug" name="wpp_settings[searchable_attributes][]" value=""/>
        ...
        <li class="wpp_development_advanced_option">
          <label>
            <input type="checkbox" class="slug" name="wpp_settings[column_attributes][]" value=""/>
        ...
        <li class="wpp_development_advanced_option en_default_value_container">
          <label>
            <input type="checkbox" class="slug en_default_value" name="wpp_settings[en_default_value][]" value=""/>
    ...
    <td class="wpp_search_input_col">
      <ul>
        <li>
          <select name="wpp_settings[searchable_attr_fields][__first_row]" class="wpp_pre_defined_value_setter wpp_searchable_attr_fields">
            <option value=""> - </option>
            <option value="input"><?php _e( 'Free Text', ud_get_wp_property()->domain ) ?></option>
            <option value="range_input"><?php _e( 'Text Input Range', ud_get_wp_property()->domain ) ?></option>
            <option value="range_dropdown"><?php _e( 'Range Dropdown', ud_get_wp_property()->domain ) ?></option>
            <option value="advanced_range_dropdown"><?php _e( 'Advanced Range Dropdown', ud_get_wp_property()->domain ) ?></option>
            <option value="dropdown"><?php _e( 'Dropdown Selection', ud_get_wp_property()->domain ) ?></option>
            <option value="checkbox"><?php _e( 'Single Checkbox', ud_get_wp_property()->domain ) ?></option>
            <option value="multi_checkbox"><?php _e( 'Multi-Checkbox', ud_get_wp_property()->domain ) ?></option>
            <?php do_action( 'wpp::property_attributes::searchable_attr_field', $slug ); ?>
          </select>
        </li>
        <li>
          <textarea class="wpp_attribute_pre_defined_values" name="wpp_settings[predefined_search_values][__first_row]"></textarea>
        </li>
      </ul>
    </td>
    ...
    <td class="wpp_admin_input_col">
      <ul>
        <li>
          <select name="wpp_settings[admin_attr_fields][__first_row]" class="wpp_pre_defined_value_setter wpp_searchable_attr_fields">
        ...
        <li>
          <textarea class="wpp_attribute_pre_defined_values" name="wpp_settings[predefined_values][__first_row]"><?php echo isset( $wp_properties[ 'predefined_values' ][ $slug ] ) ? $wp_properties[ 'predefined_values' ][ $slug ] : ''; ?></textarea>
        </li>
        <?php $class = "hidden" /* || shown*/?>
        <li class="wpp_attribute_default_values <?php echo $class;?>">
          <?php
          $input_type = $wp_properties[ 'admin_attr_fields' ][ '__first_row' ];
          $value = "";
          $field_name = "wpp_settings[default_values][__first_row]";
          ...
          ?>
          <a class="button apply-to-all" data-attribute="<?php echo '__first_row';?>" href="#" title="<?php _e("Apply to listings that have no value for this field.", ud_get_wp_property()->domain);?>" ><?php _e("Apply to all", ud_get_wp_property()->domain);?></a> <br/>
        </li>
      </ul>
    </td>
  </tr>
