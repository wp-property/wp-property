...
<table id="wpp_inquiry_property_types" class="ud_ui_dynamic_table widefat" allow_random_slug="true">
  ...
  <tr  class="wpp_dynamic_table_row donor_row" slug="__first_row"  data-property-slug="__first_row" new_row='false' style="display: none">
    <td>
      <ul>
        <li><input class="slug_setter" type="text" id="1" name="wpp_settings[property_types][__first_row]" value=""/></li>
        <li><input type="text" class="slug" readonly='readonly' value=""/></li>
        <li><span class="wpp_delete_row wpp_link">Delete</span></li>
      </ul>
    </td>
    <td>
      <div class="upload-image-section">
        <input type="hidden" name="wpp_settings[configuration][default_image][types][][url]" class="input-image-url" value="<?php echo isset( $wp_properties[ 'configuration' ][ 'default_image' ]['types'][$property_slug]['url'] ) ? $wp_properties[ 'configuration' ][ 'default_image' ]['types'][$property_slug]['url'] : ''; ?>">
        <input type="hidden" name="wpp_settings[configuration][default_image][types][][id]" class="input-image-id" value="<?php echo isset( $wp_properties[ 'configuration' ][ 'default_image' ]['types'][$property_slug]['id'] ) ? $wp_properties[ 'configuration' ][ 'default_image' ]['types'][$property_slug]['id'] : ''; ?>">
    ...
    <td>
      <ul>
        <li>
          <label for="">
            <input class="slug" type="checkbox" name="wpp_settings[searchable_property_types][]" value=""/>
            <?php _e( 'Searchable', ud_get_wp_property()->domain ) ?>
          </label>
        </li>
        <li>
          <label for="">
            <input class="slug" type="checkbox" name="wpp_settings[location_matters][]" value=""/>
      ...
      <ul class="wp-tab-panel wpp_hidden_property_attributes wpp_something_advanced_wrapper">
        ...
        <?php foreach( $wp_properties[ 'property_stats' ] as $property_stat_slug => $property_stat_label ) : ?>
          <li class="wpp_development_advanced_option">
            <input id="" type="checkbox" name="wpp_settings[hidden_attributes][][]" value=""/>
            <label for="">
        ...
        <?php if( empty( $wp_properties[ 'property_stats' ][ 'parent' ] ) ) : ?>
          <li class="wpp_development_advanced_option">
            <input id="" type="checkbox" name="wpp_settings[hidden_attributes][][]" value="parent"/>
            <label for=""><?php _e( 'Parent Selection', ud_get_wp_property()->domain ); ?></label>
          </li>
        <?php endif; ?>
      </ul>
    </td>
