...
<table id="wpp_inquiry_property_types" class="ud_ui_dynamic_table widefat last_delete_row" allow_random_slug="true">
  ...
  <tr class="wpp_dynamic_table_row delete_class_rows" slug=""  data-property-slug="" new_row=''  style="display:none;">

      <td>
        <ul>
          <li><input class="slug_setter" type="text" name="wpp_settings[property_types][]" value=""/></li>
      ...
      <td>
        <div class="upload-image-section">
          <input type="hidden" name="wpp_settings[configuration][default_image][types][][url]" class="input-image-url" value="">
          <input type="hidden" name="wpp_settings[configuration][default_image][types][][id]" class="input-image-id" value="">
          <div class="image-actions">
            <input type="button" class="button-secondary button-setup-image" value="<?php _e( 'Setup Image', ud_get_wp_property('domain') ); ?>" title="<?php printf( __( 'If %1$s has no any image, the default one based on %1$s Type will be shown.', ud_get_wp_property('domain') ), \WPP_F::property_label() ); ?>">
          </div>
          <div class="image-wrapper"></div>
      ...
      <td>
        <ul>
          <li>
            <label for="_searchable_property_types">
              <input class="slug" id="_searchable_property_types" type="checkbox" name="wpp_settings[searchable_property_types][]" value=""/>
              <?php _e( 'Searchable', ud_get_wp_property()->domain ) ?>
            </label>
          </li>
          ...
          <li>
            <label for="<?php echo $property_slug; ?>_location_matters">
              <input class="slug" id="_location_matters" type="checkbox" name="wpp_settings[location_matters][]" value=""/>
              <?php _e( 'Location Matters', ud_get_wp_property()->domain ) ?>
            </label>
          </li>
