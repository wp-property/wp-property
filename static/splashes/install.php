      ...
      <div class="wrap about-wrap">
        ...
        <div id="wpp-splash-screen">
          ...
          <div class="loader-div"><img
              src="<?php echo ud_get_wp_property()->path('/static/splashes/assets/images/loader.gif', 'url'); ?>"
              alt="image"></div>
...
<<<<<<< HEAD
                <div class="wpp_asst_screen wpp_asst_screen_1">
                  ...
                  <h1><?php echo __('WP-PROPERTY PLUGIN!', ud_get_wp_property()->domain); ?></h1>
                  <p
                    class="tagline"><?php echo __('Make few steps in order to set up it on your site!', ud_get_wp_property()->domain); ?></p>
                  <center>
                    <button type="button"
                            class="btn_letsgo"><?php echo __("LET'S GO!", ud_get_wp_property()->domain); ?></button>
                  </center>
                </div>
              </div>
...
>>>>>>> 3833444e6c521a1e63a5840bd6d587f65b179c9d
                    ...
                    <ul class="">
                      <li class="wpp_asst_label"><?php echo __('House', ud_get_wp_property()->domain); ?>
                        <label for="property_types_house">
                          <input type="checkbox" class="wpp_box asst_prop_types"
                                 name="wpp_settings[property_types][house]" value="House"
                                 id="property_types_house" <?php if (isset($wp_properties['property_types']) && in_array("house", array_keys($wp_properties['property_types']))) echo "checked"; ?> />
                          <span></span> </label></li>
                      ...
                      <li class="wpp_asst_label">
                        ...
                        <label for="property_types_condo">
                          <input type="checkbox" class="wpp_box asst_prop_types"
                                 name="wpp_settings[property_types][condo]" value="Condo"
                                 id="property_types_condo" <?php if (isset($wp_properties['property_types']) && in_array("condo", array_keys($wp_properties['property_types']))) echo "checked"; ?> />
                          <span></span> </label></li>

                      <li class="wpp_asst_label"> <?php echo __('Townhouse', ud_get_wp_property()->domain); ?>
                        <label for="property_types_townhouse">
                          <input type="checkbox" class="wpp_settings_property_stats"
                                 name="wpp_settings[property_types][townhouse]" id="property_types_townhouse"
                                 value="Townhouse" <?php if (isset($wp_properties['property_types']) && in_array("townhouse", array_keys($wp_properties['property_types']))) echo "checked"; ?>/>
                          <span></span> </label></li>

                      <li class="wpp_asst_label"> <?php echo __('Multi-Family', ud_get_wp_property()->domain); ?>
                        <label for="property_types_multifamily">
                          <input class="wpp_box  asst_prop_types" id="property_types_multifamily" type="checkbox"
                                 value="Multi-Family" data-label=""
                                 name="wpp_settings[property_types][multifamily]" <?php if (isset($wp_properties['property_types']) && in_array("multifamily", array_keys($wp_properties['property_types']))) echo "checked"; ?>>
                          <span></span> </label></li>

                      <li class="wpp_asst_label"> <?php echo __('Land', ud_get_wp_property()->domain); ?>
                        <label for="property_types_land">
                          <input class="wpp_box asst_prop_types" type="checkbox" value="Land"
                                 name="wpp_settings[property_types][land]"
                                 id="property_types_land" <?php if (isset($wp_properties['property_types']) && in_array("land", array_keys($wp_properties['property_types']))) echo "checked"; ?>>
                          <span></span> </label></li>

                      <li class="wpp_asst_label"> <?php echo __('Commercial', ud_get_wp_property()->domain); ?>
                        <label for="property_types_commercial">
                          <input class="wpp_box asst_prop_types" type="checkbox" value="Commercial"
                                 name="wpp_settings[property_types][commercial]"
                                 id="property_types_commercial" <?php if (isset($wp_properties['property_types']) && in_array("commercial", array_keys($wp_properties['property_types']))) echo "checked"; ?>
                                 accept=""> <span></span> </label></li>
                    </ul>
                  </div> <!-- wpp_asst_inner_wrap -->

                  <div class="foot-note">
                    <h3> <?php echo __('We Will add Appropriate attributes for types you have selected', ud_get_wp_property()->domain); ?></h3>
                  </div>
              ...
              <div class="item">
                <div class="wpp_asst_screen wpp_asst_screen_3">
                  <h2 class="wpp_asst_heading">
                    <b><?php echo __('Add test properties to the site?', ud_get_wp_property()->domain); ?></b></h2>
                  <div class="wpp_asst_inner_wrap">
                    <ul>
                      <li class="wpp_asst_label"> <?php echo __('Yes Please', ud_get_wp_property()->domain); ?><label
                          for="yes-please">
                          <input class="wpp_box" type="radio" value="yes-please"
                                 name="wpp_settings[configuration][dummy-prop]"
                                 id="yes-please" <?php if (isset($wp_properties['configuration']['dummy-prop']) && $wp_properties['configuration']['dummy-prop'] == "yes-please") echo "checked='checked'"; ?>>
                          <span></span> </label>
                      </li>
                      <li
                        class="wpp_asst_label narrow"><?php echo __('No, thanks i have already</br> added properties', ud_get_wp_property()->domain); ?>
                        <label for="no-thanks">
                          <input class="wpp_box" type="radio" value="no-thanks"
                                 name="wpp_settings[configuration][dummy-prop]"
                                 id="no-thanks" <?php if (isset($wp_properties['configuration']['dummy-prop']) && $wp_properties['configuration']['dummy-prop'] == "no-thanks") echo "checked='checked'"; ?> >
                          <span></span> </label>
                      </li>
                    </ul>
                  </div>
                  ...
                  <h2 class="wpp_asst_heading">
                    <b><?php echo __('Add Widgets to the single property pages?', ud_get_wp_property()->domain); ?></b>
                  </h2>
                  <div class="wpp_asst_inner_wrap">
                    <ul>
                      <li class="wpp_asst_label"><?php echo __('Property Gallery', ud_get_wp_property()->domain); ?>
                        <label for="gallerypropertieswidget">
                          <input class="wpp_box" type="checkbox" value="gallerypropertieswidget"
                                 name="wpp_settings[configuration][widgets][gallerypropertieswidget]"
                                 value="gallerypropertieswidget"
                                 id="gallerypropertieswidget" <?php if (isset($wp_properties['configuration']['widgets']) && in_array("gallerypropertieswidget", array_keys($wp_properties['configuration']['widgets']))) echo "checked"; ?>>
                          <span></span> </label>
                      </li>
              ...
              <div class="item item-wider">
                <div class="wpp_asst_screen wpp_asst_screen_4">
                  <h2 class="wpp_asst_heading">
                    <b><?php echo __('Choose default properties pages', ud_get_wp_property()->domain); ?></b></h2>
                  <div class="wpp_asst_inner_wrap">
                    <div class="wpp_asst_select">
                      <select id="soflow" name="wpp_settings[configuration][base_slug]">
                        ...
                        foreach ($pages as $page) {
                          ?>
                          <option
                            value="<?php echo $page->post_name; ?>" <?php selected($wp_properties['configuration']['base_slug'], $page->post_name); ?>
                            class="list_property"><?php echo $page->post_title; ?></option>
                        <?php } ?>
                        <option value="create-new"
                                class="list_property"><?php echo __('Create a new page', ud_get_wp_property()->domain); ?></option>
                      </select>
                    </div>
                    ...
                    <h2 class="wpp_asst_heading">
                      <b><?php echo __('Add list of properties to your Properties page?', ud_get_wp_property()->domain); ?></b>
                    </h2>

                    <div class="wpp_asst_inner_wrap">
                      <ul class="three-sectionals">
                        <li class="wpp_asst_label"> <?php echo __('Sure', ud_get_wp_property()->domain); ?><label
                            for="true">
                            <input class="wpp_box" type="checkbox" value="true"
                                   name="wpp_settings[configuration][automatically_insert_overview]"
                              <?php if (isset($wp_properties['configuration']['automatically_insert_overview']) && !empty($wp_properties['configuration']['automatically_insert_overview'])) echo "checked"; ?>
              ...
              <div class="item">
                <div class="wpp_asst_screen wpp_asst_screen_5 wpp_map_api_screen">
                  <h2 class="wpp_asst_heading">
                    <b><?php echo __('Google Maps API ', ud_get_wp_property()->domain); ?></b></h2>
                  <span
                    class="description"><?php echo __('Google Maps requires API key to be shown on your single property pages.', ud_get_wp_property('domain')); ?><?php printf(__('%s Where can I get the key ? %s', ud_get_wp_property('domain')), '<a href="https://developers.google.com/maps/documentation/javascript/get-api-key" target="_blank">( ', ' ) </a>'); ?></span>
              ...
              <div class="item">
                <div class="wpp_asst_screen wpp_asst_screen_6">
                  <h2 class="wpp_asst_heading text-center">
                    <b><?php echo __("Let's view what we have", ud_get_wp_property()->domain); ?></b></h2>
                  <ul class="list-img">
                    <li>
                      <span><img
                          src="<?php echo ud_get_wp_property()->path('/static/splashes/assets/images/wpp-single-prop.jpg', 'url'); ?>"
                          alt="image"></span>
                      <center><a class="btn_single_page props"
                                 href="javascript:;"><?php echo __('SINGLE PROPERTY PAGE', ud_get_wp_property()->domain); ?></a>
                      </center>
                    </li>
                    <li>
                      <img
                        src="<?php echo ud_get_wp_property()->path('/static/splashes/assets/images/overview-prop.jpg', 'url'); ?>"
                        alt="image">
                      <center><a class="btn_single_page oviews"
                                 href="javascript:;"><?php echo __('OVERVIEW OF PROPERTIES', ud_get_wp_property()->domain); ?></a>
                      </center>
                    </li>
                  </ul>
                </div>
