(function ( $ )
{
  ...
  MapField.prototype = {
    ...
    initDomElements   : function ()
    {
      ...
      this.$wpp_meta_latitude = this.$container.parent().find( '#wpp_meta_latitude' );
      this.$wpp_meta_longitude = this.$container.parent().find( '#wpp_meta_longitude' );
    ...
    updateCoordinate  : function ( latLng )
    {
      ...
      this.$wpp_meta_latitude.val( latLng.lat() );
      this.$wpp_meta_longitude.val( latLng.lng() );
    },
