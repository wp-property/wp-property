!function($) {
    ...
    $.each({
        ...
        $.event.special[fix] = {
            setup: function() {
                return $.browser.msie ? !1 : void this.addEventListener(original, $.event.special[fix].handler, !0);
            },
            teardown: function() {
                return $.browser.msie ? !1 : void this.removeEventListener(original, $.event.special[fix].handler, !0);
            },
            handler: function(e) {
